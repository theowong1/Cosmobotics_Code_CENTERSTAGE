...
public class RedClose extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Auton RedClose = new Auton(hardwareMap, leftSpikePose, centerSpikePose, rightSpikePose);
        SampleMecanumDrive drive = RedClose.drive();
        ...
        if (opModeIsActive()) {
            RedClose.RedSpikeAuton();
            RedClose.BoardAuton(leftBoard, centerBoard, rightBoard);
            RedClose.ToStack(leftStack, centerStack, rightStack);
            RedClose.FromStack(leftReturn, centerReturn, rightReturn);
            RedClose.BoardPark(leftLeftPark, centerLeftPark, rightLeftPark);
            RedClose.BoardPark(leftRightPark, centerRightPark, rightRightPark);
        }
    }
}